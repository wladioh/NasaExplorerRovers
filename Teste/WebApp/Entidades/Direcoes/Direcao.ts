module Entidades {
    export class Direcao {
        ...
        public podeMover(terreno: Entidades.Terreno, coordenada: Entidades.Coordenada): boolean {
            var coordenadaFutura = new Coordenada(coordenada.getEixoX(), coordenada.getEixoY());
