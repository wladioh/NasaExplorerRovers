...
describe("Direção Teste", () => {
    ...
    it("certifica que pode mover na direcao norte em um terreno", () => {
        var norte = new Entidades.Norte();
    ...
    it("certifica que não pode mover na direcao norte em um terreno", () => {
        var norte = new Entidades.Norte();
    ...
    it("certifica que pode mover na direcao sul em um terreno", () => {
        var norte = new Entidades.Norte();
    ...
    it("certifica que não pode mover na direcao sul em um terreno", () => {
        var sul = new Entidades.Sul();
    ...
    it("certifica que pode mover na direcao oeste em um terreno", () => {
        var oeste = new Entidades.Oeste();
    ...
    it("certifica que não pode mover na direcao oeste em um terreno", () => {
        var oeste = new Entidades.Oeste();
        var coordenada = new Entidades.Coordenada(0, 0);
        var limite = new Entidades.Coordenada(2, 2);
        var terreno = new Entidades.Terreno(limite);
    ...
    it("certifica que pode mover na direcao leste em um terreno", () => {
        var oeste = new Entidades.Oeste();
    ...
    it("certifica que não pode mover na direcao leste em um terreno", () => {
        var leste = new Entidades.Leste();
        var coordenada = new Entidades.Coordenada(2, 2);
        var limite = new Entidades.Coordenada(2, 2);
        var terreno = new Entidades.Terreno(limite);
